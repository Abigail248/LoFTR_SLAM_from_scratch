...
//BOOST_CLASS_EXPORT_GUID(Pinhole, "Pinhole")
    ...
    bool Pinhole::ReconstructWithEmt(const std::vector<cv::KeyPoint> &vKeys1, const std::vector<cv::KeyPoint> &vKeys2,
        ...
        return tvr->ReconstructEmt(vKeys1,vKeys2,vMatches12,T21,vP3D,vbTriangulated);
    }
