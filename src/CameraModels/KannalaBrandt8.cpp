...
//BOOST_CLASS_EXPORT_GUID(KannalaBrandt8, "KannalaBrandt8")
    ...
    bool KannalaBrandt8::ReconstructWithEmt(const std::vector<cv::KeyPoint> &vKeys1,
                                            ...
                                            std::vector<bool> &vbTriangulated)
                                            {
                                                ...
                                                return tvr->ReconstructEmt(vKeysUn1,vKeysUn2,vMatches12,T21,vP3D,vbTriangulated);
    }
